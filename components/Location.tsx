              ...
              <div className="absolute bottom-8 left-8 right-8">
                <div className="bg-white/10 backdrop-blur-md p-6 rounded-2xl border border-white/20">
                  <h4 className="text-xl font-bold text-white mb-2 flex items-center">
                    ...
                    {settings.location_referencia || "Escola de Condução EBJ"}
                  </h4>
                  <p className="text-gray-300 text-sm">{settings.location_address || CONTACT_INFO.address + ", " + CONTACT_INFO.city}</p>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-400">{settings.location_referencia || "Ao lado da Escola de condução EBJ, Cabassango."}</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-400">{settings.whatsapp_phone || CONTACT_INFO.phone}</p>
            ...
            <div className="pt-8">
              ...
              <Button
                ...
                onClick={() => settings.location_gmaps_url && window.open(settings.location_gmaps_url, '_blank')}
              >
