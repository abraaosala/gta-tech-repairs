        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative">
              ...
              <div className="absolute bottom-8 left-8 right-8">
                <div className="bg-white/10 backdrop-blur-md p-6 rounded-2xl border border-white/20">
                  <h4 className="text-xl font-bold text-white mb-2 flex items-center">
                    ...
                    {settings.location_title || "Escola de Condução EBJ"}
                  </h4>
                  <p className="text-gray-300 text-sm">
                    {settings.contact_address || "Escola de condução EBJ, Cabassango"}, {settings.contact_city || "Cabinda - Angola"}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="absolute -top-6 -right-6 bg-brand-yellow text-brand-dark p-6 rounded-full shadow-[0_0_30px_rgba(255,204,0,0.4)] animate-bounce hidden md:block">
              <span className="font-black text-xl block text-center">{settings.repair_time_badge || "30min"}</span>
          ...
          <div className="space-y-8">
            ...
            <p className="text-gray-300 text-lg">
              {settings.location_description || "Localizados estrategicamente para melhor lhe atender. Nossa loja conta com laboratório certificado e sala de espera confortável."}
            </p>
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-400">{settings.location_reference || "Ao lado da Escola de condução EBJ, Cabassango."}</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-400">{settings.contact_phone || "+244 973 933 880"}</p>
