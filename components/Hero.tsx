      ...
      <div className="container mx-auto px-6 relative z-10 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-8 text-center md:text-left">
          ...
          <h1 className="text-5xl md:text-7xl font-black text-white leading-tight">
            Loca<br/>
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-cyan to-white">Lização</span>
            <span className="text-brand-yellow">.</span>
          </h1>
          
          <p className="text-gray-300 text-lg md:text-xl max-w-lg mx-auto md:mx-0 leading-relaxed">
            Assistência técnica especializada com a confiança que você merece. Reparos rápidos, peças de qualidade e atendimento premium.
          </p>
