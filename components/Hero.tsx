      ...
      <div className="container mx-auto px-6 relative z-10 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-8 text-center md:text-left">
          <div className="inline-flex items-center space-x-2 bg-white/5 border border-brand-cyan/30 rounded-full px-4 py-1.5 backdrop-blur-sm">
            ...
            <span className="text-brand-cyan text-xs font-bold uppercase tracking-wider">
              {settings.hero_badge || "Disponível em Cabinda"}
            </span>
          </div>

          <h1 className="text-5xl md:text-7xl font-black text-white leading-tight">
            <span dangerouslySetInnerHTML={{ __html: settings.hero_title || `Loca<br/><span class="text-transparent bg-clip-text bg-gradient-to-r from-brand-cyan to-white">Lização</span><span class="text-brand-yellow">.</span>` }} />
          </h1>
          ...
          <div className="relative z-10 w-full max-w-[350px] mx-auto transform transition-transform duration-500 group-hover:rotate-y-6 group-hover:rotate-x-6">
            ...
            <div className="rounded-[2.5rem] border-[8px] border-gray-800 bg-gray-900 shadow-2xl overflow-hidden relative aspect-[9/19]">
              ...
              <div className="absolute inset-0 bg-gray-800">
                <img
                  src={settings.hero_image_url || "https://img.freepik.com/fotos-gratis/serviceman-usa-lupa-e-chave-de-fenda-para-reparar-smartphone-danificado-na-oficina-eletronica_613910-20797.jpg?semt=ais_hybrid&w=740&q=80"}
                  alt="Técnico"
                ...
                <div className="absolute bottom-8 left-6 right-6 p-4 bg-white/10 backdrop-blur-md border border-white/20 rounded-xl">
                  ...
                  <p className="text-gray-200 text-xs flex items-center">
                    ...
                    {settings.contact_city || "Cabassango, Angola"}
                  </p>
